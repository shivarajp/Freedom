...
import com.freedom.musicplayer.dataloaders.AlbumLoader;
import com.freedom.musicplayer.dataloaders.AlbumSongLoader;
import com.freedom.musicplayer.dataloaders.ArtistAlbumLoader;
import com.freedom.musicplayer.dataloaders.ArtistLoader;
import com.freedom.musicplayer.dataloaders.ArtistSongLoader;
import com.freedom.musicplayer.dataloaders.PlaylistLoader;
import com.freedom.musicplayer.dataloaders.PlaylistSongLoader;
import com.freedom.musicplayer.dataloaders.SongLoader;
import com.freedom.musicplayer.models.Album;
import com.freedom.musicplayer.models.Artist;
import com.freedom.musicplayer.models.Playlist;
import com.freedom.musicplayer.models.Song;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "freedom.musicplayer/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "freedom.musicplayer/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "freedom.musicplayer/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "freedom.musicplayer/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
